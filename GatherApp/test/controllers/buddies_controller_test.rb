...
class BuddiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buddy" do
    assert_difference('Buddy.count') do
      post buddies_url, params: { buddy: { buddy_email: @buddy.buddy_email, buddy_first_name: @buddy.buddy_first_name, buddy_last_name: @buddy.buddy_last_name } }
    end
  ...
  test "should update buddy" do
    patch buddy_url(@buddy), params: { buddy: { buddy_email: @buddy.buddy_email, buddy_first_name: @buddy.buddy_first_name, buddy_last_name: @buddy.buddy_last_name } }
